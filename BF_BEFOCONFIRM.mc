...
//보일러 수정
	...
	long m_lpage = 0;
	long m_lTotpage = 0;
	long m_lTotCnt = 0;			//리스트 갯수
	long m_lLstCnt = 0;			//리스트
	long m_lSelIndex = -1;
	long m_bFirst;
	long m_lPrev = 0;
	...
	DlgObject	DlgRes[] = 
	{
		...
		DLG_BUTTON(STARTX,     STARTY+840, 250, 59, 0, 0, BUTSTY_BOLD, BUTSTY_BORDER, BTNMENUFRCOLOR, BTNCTRLBKCOLOR, CALL_FUNC , "", BID_PREVPG, "◀"),
		DLG_BUTTON(STARTX+250, STARTY+840, 250, 59, 0, 0, BUTSTY_BOLD, BUTSTY_BORDER, BTNMENUFRCOLOR, BTNCTRLBKCOLOR, CALL_FUNC , "", BID_NEXTPG, "▶"),
		DLG_BUTTON(STARTX+500, STARTY+840, 250, 59, 0, 0, BUTSTY_BOLD, BUTSTY_BORDER, BTNMENUFRCOLOR, BTNCTRLBKCOLOR, CALL_FUNC , "", BID_BF, "점검"),
		DLG_BUTTON(STARTX+750, STARTY+840, 250, 59, 0, 0, BUTSTY_BOLD, BUTSTY_BORDER, BTNMENUFRCOLOR, BTNCTRLBKCOLOR, CALL_FUNC , "", BID_SIGN, "서명"),
		...
		DLG_TEXT(STARTX+200,  STARTY+315, 400, 50, 0, 0, 0, EDITSTY_BORDER, TXTFRCOLOR, TXTINCTRLBK, TXT_DATA10, ""),
		...
		DLG_EDIT(STARTX+130,  STARTY+465, 200, 60, 0, 0, EDITSTY_BOLD, EDITSTY_BORDER, TXTFRCOLOR, PDAEDTCTRLBK, EDT_VC, 9,  ""),
		DLG_TEXT(STARTX+330,  STARTY+465, 130, 60, 0, 0, 0, EDITSTY_BORDER, TXTTTLFRCOLOR, TXTCTRLBK, TXT_DATA19, "VM"),
		DLG_EDIT(STARTX+460,  STARTY+465, 200, 60, 0, 0, EDITSTY_BOLD, EDITSTY_BORDER, TXTFRCOLOR, PDAEDTCTRLBK, EDT_VM, 9,  ""),
		DLG_TEXT(STARTX+660,  STARTY+465, 130, 60, 0, 0, 0, EDITSTY_BORDER, TXTTTLFRCOLOR, TXTCTRLBK, TXT_DATA21, "VA"),
		DLG_EDIT(STARTX+790,  STARTY+465, 210, 60, 0, 0, EDITSTY_BOLD, EDITSTY_BORDER, TXTFRCOLOR, PDAEDTCTRLBK, EDT_VA, 9,  ""),
	...
	DlgObject	DlgRes_P[] = 
	{
		...
		DLG_BUTTON(STARTX,      STARTY+70, 220, 110, 0, 0, BUTSTY_BOLD, BUTSTY_BORDER, BTNMENUFRCOLOR, BTNCTRLBKCOLOR, CALL_FUNC , "", BID_ADDR, "지번\n주소"),
		DLG_BUTTON(STARTX+200, STARTY+440, 260, 60, 0, 0, BUTSTY_BOLD, BUTSTY_BORDER, BTNMENUFRCOLOR, BTNCTRLBKCOLOR, CALL_FUNC , "", BID_CHANGE, "수정"),
		DLG_BUTTON(STARTX+460, STARTY+440, 260, 60, 0, 0, BUTSTY_BOLD, BUTSTY_BORDER, BTNMENUFRCOLOR, BTNCTRLBKCOLOR, CALL_FUNC , "", BID_DELETE, "삭제"),
		DLG_BUTTON(STARTX+720, STARTY+440, 280, 60, 0, 0, BUTSTY_BOLD, BUTSTY_BORDER, BTNMENUFRCOLOR, ORANGE, CALL_FUNC , "", BID_DELCANCEL, "삭제취소"),
		DLG_BUTTON(STARTX,     STARTY+800, 250, 99, 0, 0, BUTSTY_BOLD, BUTSTY_BORDER, BTNMENUFRCOLOR, BTNCTRLBKCOLOR, CALL_FUNC , "", BID_PREVPG, "◀"),
		DLG_BUTTON(STARTX+250, STARTY+800, 250, 99, 0, 0, BUTSTY_BOLD, BUTSTY_BORDER, BTNMENUFRCOLOR, BTNCTRLBKCOLOR, CALL_FUNC , "", BID_NEXTPG, "▶"),
		DLG_BUTTON(STARTX+500, STARTY+800, 250, 99, 0, 0, BUTSTY_BOLD, BUTSTY_BORDER, BTNMENUFRCOLOR, BTNCTRLBKCOLOR, CALL_FUNC , "", BID_BF, "점검"),
		DLG_BUTTON(STARTX+750, STARTY+800, 250, 99, 0, 0, BUTSTY_BOLD, BUTSTY_BORDER, BTNMENUFRCOLOR, BTNCTRLBKCOLOR, CALL_FUNC , "", BID_SIGN, "서명"),

		DLG_TEXT(STARTX+700,   STARTY-40, 300, 60, 0, 0, 0, EDITSTY_BORDER, TXTFRCOLOR, TXTINCTRLBK, TXT_PAGE, m_szCnt_index), 
		DLG_TEXT(STARTX,       STARTY+20, 220, 50, 0, 0, 0, EDITSTY_BORDER, TXTTTLFRCOLOR, TXTCTRLBK, TXT_DATA1, "고객"),
		DLG_TEXT(STARTX+220,   STARTY+20, 390, 50, 0, 0, 0, EDITSTY_BORDER, TXTFRCOLOR, TXTINCTRLBK, TXT_DATA2, ""),
		DLG_TEXT(STARTX+610,   STARTY+20, 390, 50, 0, 0, 0, EDITSTY_BORDER, TXTFRCOLOR, TXTINCTRLBK, TXT_DATA3, ""),
		DLG_TEXT(STARTX+220,   STARTY+70, 780, 110, 0, 0, 0, EDITSTY_BORDER, TXTFRCOLOR, TXTINCTRLBK, TXT_DATA4, ""), //주소
		DLG_TEXT(STARTX,      STARTY+180, 220, 50, 0, 0, 0, EDITSTY_BORDER, TXTTTLFRCOLOR, TXTCTRLBK, TXT_DATA6, "HP/TEL"),
		...
		DLG_BUTTON(STARTX+220,  STARTY+180, 390, 50, 0, 0, BUTSTY_BOLD, BUTSTY_BORDER, BTNMENUFRCOLOR, BTNCTRLBKCOLOR, CALL_FUNC , "", BID_PHONETEL, ""),
		DLG_BUTTON(STARTX+610,  STARTY+180, 390, 50, 0, 0, BUTSTY_BOLD, BUTSTY_BORDER, BTNMENUFRCOLOR, BTNCTRLBKCOLOR, CALL_FUNC , "", BID_HOUSETEL, ""),
		DLG_TEXT(STARTX,      STARTY+230, 220, 50, 0, 0, 0, EDITSTY_BORDER, TXTTTLFRCOLOR, TXTCTRLBK, TXT_DATA9, "계량기"),
		...
		DLG_TEXT(STARTX,      STARTY+280, 220, 50, 0, 0, 0, EDITSTY_BORDER, TXTTTLFRCOLOR, TXTCTRLBK, TXT_DATA13, "모델"),
		...
		DLG_TEXT(STARTX,      STARTY+330, 220, 50, 0, 0, 0, EDITSTY_BORDER, TXTTTLFRCOLOR, TXTCTRLBK, TXT_DATA17, "보험"),
		...
		DLG_EDIT(STARTX+130,  STARTY+380, 200, 60, 0, 0, EDITSTY_BOLD, EDITSTY_BORDER, TXTFRCOLOR, PDAEDTCTRLBK, EDT_VC, 9,  ""),
		DLG_TEXT(STARTX+330,  STARTY+380, 130, 60, 0, 0, 0, EDITSTY_BORDER, TXTTTLFRCOLOR, TXTCTRLBK, TXT_DATA19, "VM"),
		DLG_EDIT(STARTX+460,  STARTY+380, 200, 60, 0, 0, EDITSTY_BOLD, EDITSTY_BORDER, TXTFRCOLOR, PDAEDTCTRLBK, EDT_VM, 9,  ""),
		DLG_TEXT(STARTX+660,  STARTY+380, 130, 60, 0, 0, 0, EDITSTY_BORDER, TXTTTLFRCOLOR, TXTCTRLBK, TXT_DATA21, "VA"),
		DLG_EDIT(STARTX+790,  STARTY+380, 210, 60, 0, 0, EDITSTY_BOLD, EDITSTY_BORDER, TXTFRCOLOR, PDAEDTCTRLBK, EDT_VA, 9,  ""),		

		DLG_TEXT(STARTX,      STARTY+440, 200, 60, 0, 0, 0, EDITSTY_BORDER, TXTFRCOLOR, TXTINCTRLBK, TXT_PAGELST, m_szCnt_page),
		DLG_TEXT(STARTX,      STARTY+735, 230, 65, 0, 0, 0, EDITSTY_BORDER, TXTTTLFRCOLOR, TXTCTRLBK, TXT_DATA25, "설치일자"),
		DLG_TEXT(STARTX+230,  STARTY+735, 300, 65, 0, 0, 0, EDITSTY_BORDER, TXTFRCOLOR, TXTINCTRLBK, TXT_DATA26, ""),
		DLG_TEXT(STARTX+530,  STARTY+735, 200, 65, 0, 0, 0, EDITSTY_BORDER, TXTTTLFRCOLOR, TXTCTRLBK, TXT_DATA27, "용량"),
		DLG_TEXT(STARTX+730,  STARTY+735, 270, 65, 0, 0, 0, EDITSTY_BORDER, TXTFRCOLOR, TXTINCTRLBK, TXT_DATA28, ""),
	...
	DlgObject	DlgRes_BOILCHG[] = 
	{
		...
		DLG_BUTTON(STARTX,     STARTY+795, 350, 80, 0, 0, BUTSTY_BOLD, BUTSTY_BORDER, BTNMENUFRCOLOR, BTNCTRLBKCOLOR, CALL_FUNC , "", BID_CANCEL, "취소"),
		DLG_BUTTON(STARTX+650, STARTY+795, 350, 80, 0, 0, BUTSTY_BOLD, BUTSTY_BORDER, BTNMENUFRCOLOR, BTNCTRLBKCOLOR, CALL_FUNC , "", BID_SAVE, "저장"),
		...
		DLG_EDIT( STARTX+300,STARTY+160, 300, 60, 0, 0, EDITSTY_BOLD, EDITSTY_BORDER, TXTFRCOLOR, EDTCTRLBK, EDT_DATA2, 10,  ""),
		...
		DLG_EDIT( STARTX+300,  STARTY+280, 200, 60, 0, 0, EDITSTY_BOLD, 0, BLACK, EDTCTRLBK, EDT_DATA4, 4,  ""),
		DLG_TEXT(STARTX+500,   STARTY+280, 18, 30, 0, 0, 0, 0, TXTFRCOLOR, EDTCTRLBK, TXT_DATA53, ""),
		DLG_TEXT(STARTX+500,   STARTY+310, 18, 30, 0, 0, 0, 0, TXTFRCOLOR, EDTCTRLBK, TXT_DATA54, "."),
		DLG_EDIT( STARTX+518,  STARTY+280, 145, 60, 0, 0, EDITSTY_BOLD, 0, BLACK, EDTCTRLBK, EDT_DATA5, 2,  ""),
		DLG_TEXT(STARTX+663,   STARTY+280, 17, 30, 0, 0, 0, 0, TXTFRCOLOR, EDTCTRLBK, TXT_DATA55, ""),
		DLG_TEXT(STARTX+663,   STARTY+310, 17, 30, 0, 0, 0, 0, TXTFRCOLOR, EDTCTRLBK, TXT_DATA56, "."),
		DLG_EDIT( STARTX+680,  STARTY+280, 145, 60, 0, 0, EDITSTY_BOLD, 0, BLACK, EDTCTRLBK, EDT_DATA6, 2,  ""),
		DLG_BUTTON(STARTX+825, STARTY+280, 175, 60, 0, 0, BUTSTY_BOLD, BUTSTY_BORDER, TXTFRCOLOR, PDAEDTCTRLBK, CALL_FUNC , "", BID_SCHDL, "▼"),
		...
		DLG_TEXT(STARTX+520, STARTY+700, 220, 60, 0, 0, 0, EDITSTY_BORDER, TXTFRCOLOR, TXTINCTRLBK, TXT_DATA49, ""),
		DLG_TEXT(STARTX+740, STARTY+700, 50 , 60, 0, 0, 0, EDITSTY_BORDER, TXTFRCOLOR, TXTINCTRLBK, TXT_DATA50, "-"),
		DLG_TEXT(STARTX+790, STARTY+700, 210, 60, 0, 0, 0, EDITSTY_BORDER, TXTFRCOLOR, TXTINCTRLBK, TXT_DATA51, ""),
		...
		DLG_COMBO (STARTX+300,  STARTY+40, 700, 290, 175, 60, TXTFRCOLOR, TXTINCTRLBK, CALL_FUNC, "", CMB_DATA3, 30),		
		DLG_COMBO (STARTX+600, STARTY+160, 400, 290, 175, 60, TXTFRCOLOR, TXTINCTRLBK, CALL_FUNC, "", CMB_DATA4, 30),		
		DLG_COMBO (STARTX+300, STARTY+220, 700, 290, 175, 60, TXTFRCOLOR, TXTINCTRLBK, CALL_FUNC, "", CMB_DATA5, 30),
		DLG_COMBO (STARTX+300, STARTY+340, 700, 290, 175, 60, TXTFRCOLOR, TXTINCTRLBK, CALL_FUNC, "", CMB_DATA6, 30),
		DLG_COMBO (STARTX+300, STARTY+400, 700, 290, 175, 60, TXTFRCOLOR, TXTINCTRLBK, CALL_FUNC, "", CMB_DATA7, 30),
		
		//DLG_COMBO (STARTX+300, STARTY+540, 675, 290, 120, 60, TXTFRCOLOR, TXTINCTRLBK, CALL_FUNC, "", CMB_DATA8, 30)
		DLG_TEXT( STARTX+300, STARTY+520 , 525, 60, 0, 0, EDITSTY_BOLD, EDITSTY_BORDER, BLACK, EDTCTRLBK, CMB_DATA8,  ""),
		DLG_BUTTON(STARTX+825, STARTY+520, 175, 60, 0, 0, BUTSTY_BOLD, BUTSTY_BORDER, TXTFRCOLOR, PDAEDTCTRLBK, CALL_FUNC , "", BID_WORKFIRM, "▼")
	};	
	...
	DlgObject	DlgRes_BOILCHG_P[] = 
	{
		...
		DLG_BUTTON(STARTX,     STARTY+780, 400, 100, 0, 0, BUTSTY_BOLD, BUTSTY_BORDER, BTNMENUFRCOLOR, BTNCTRLBKCOLOR, CALL_FUNC , "", BID_CANCEL, "취소"),
		DLG_BUTTON(STARTX+600, STARTY+780, 400, 100, 0, 0, BUTSTY_BOLD, BUTSTY_BORDER, BTNMENUFRCOLOR, BTNCTRLBKCOLOR, CALL_FUNC , "", BID_SAVE, "저장"),
		...
		DLG_EDIT( STARTX+300, STARTY+80, 700, 60, 0, 0, EDITSTY_BOLD, EDITSTY_BORDER, TXTFRCOLOR, EDTCTRLBK, EDT_DATA1, 50, ""),
		DLG_TEXT(STARTX, 	 STARTY+140, 300, 60, 0, 0, 0, EDITSTY_BORDER, TXTTTLFRCOLOR, TXTCTRLBK, 	TXT_DATA34, "용량"),
		DLG_EDIT( STARTX+300,STARTY+140, 300, 60, 0, 0, EDITSTY_BOLD, EDITSTY_BORDER, TXTFRCOLOR, EDTCTRLBK, EDT_DATA2, 10,  ""),
		...
		DLG_EDIT( STARTX+300,  STARTY+260, 200, 60, 0, 0, EDITSTY_BOLD, EDITSTY_BORDER, BLACK, EDTCTRLBK, EDT_DATA4, 4,  ""),
		DLG_TEXT(STARTX+500,   STARTY+260, 20, 30, 0, 0, 0, 0, TXTFRCOLOR, EDTCTRLBK, TXT_DATA53, ""),
		DLG_TEXT(STARTX+500,   STARTY+280, 20, 30, 0, 0, 0, 0, TXTFRCOLOR, EDTCTRLBK, TXT_DATA54, "."),
		DLG_EDIT( STARTX+520,  STARTY+260, 145, 60, 0, 0, EDITSTY_BOLD, EDITSTY_BORDER, BLACK, EDTCTRLBK, EDT_DATA5, 2,  ""),
		DLG_TEXT(STARTX+665,   STARTY+260, 20, 30, 0, 0, 0, 0, TXTFRCOLOR, EDTCTRLBK, TXT_DATA55, ""),
		DLG_TEXT(STARTX+665,   STARTY+280, 20, 30, 0, 0, 0, 0, TXTFRCOLOR, EDTCTRLBK, TXT_DATA56, "."),
		DLG_EDIT( STARTX+685,  STARTY+260, 145, 60, 0, 0, EDITSTY_BOLD, EDITSTY_BORDER, BLACK, EDTCTRLBK, EDT_DATA6, 2,  ""),
		...
		DLG_TEXT(STARTX+250, STARTY+680, 210, 60, 0, 0, 0, EDITSTY_BORDER, TXTFRCOLOR, TXTINCTRLBK, TXT_DATA47, ""),
		DLG_TEXT(STARTX+460, STARTY+680, 50 , 60, 0, 0, 0, EDITSTY_BORDER, TXTFRCOLOR, TXTINCTRLBK, TXT_DATA48, "-"),
		DLG_TEXT(STARTX+510, STARTY+680, 220, 60, 0, 0, 0, EDITSTY_BORDER, TXTFRCOLOR, TXTINCTRLBK, TXT_DATA49, ""),
...
//보일러 수정
			case BID_WRITE1:
			{
				handle h = Get_hDlgCtrlByID(EDT_DATA1);
				
				EditCtrl_ShowEditInput( h, EditCtrl_GetStr(h) );
				break;
			}	
				
			case BID_WRITE2:
			{
				handle h = Get_hDlgCtrlByID(EDT_DATA3);
	...
	void	OnPointing(long nAction, long X, long Y)
	{
		...
		if( m_bFirst == INIT_MAIN )
		{
			if( POINTING_UP == nAction )
			{
				...
				if( theDevInfo.m_nType > FAMILY_PDA )
				{
					...
					{
						if( X > DMS_X(STARTX+130) && X < DMS_X(STARTX+330) && Y > DMS_Y(STARTY+465-(g_Dlgflag*400)) && Y < DMS_Y(STARTY+525-(g_Dlgflag*400)) )
						{
					...
					{
						if( X > DMS_X(STARTX+130) && X < DMS_X(STARTX+330) && Y > DMS_Y(STARTY+465-(g_Dlgflag*400)) && Y < DMS_Y(STARTY+525-(g_Dlgflag*400)) ||
							X > DMS_X(STARTX+460) && X < DMS_X(STARTX+660) && Y > DMS_Y(STARTY+465-(g_Dlgflag*400)) && Y < DMS_Y(STARTY+525-(g_Dlgflag*400)) ||
							X > DMS_X(STARTX+790) && X < DMS_X(STARTX+1000) && Y > DMS_Y(STARTY+465-(g_Dlgflag*400)) && Y < DMS_Y(STARTY+525-(g_Dlgflag*400)) )
						{
							if( Get_iDlgCtrlByID(EDT_VC) == lActiveIndex ||
		...
		else if( m_bFirst == INIT_BOILCHG )
		{
			if( POINTING_UP == nAction )
			{
				...
				if( theDevInfo.m_nType > FAMILY_PDA )
				{
					if( X > DMS_X(STARTX+300) && X < DMS_X(STARTX+600) && Y > DMS_Y(STARTY+180) && Y < DMS_Y(STARTY+240) )
					{
						if( Get_iDlgCtrlByID(EDT_DATA2) == lActiveIndex )
						{
							...
							g_Sipflag = 1;
					         ...
					         X > DMS_X(STARTX+518) && X < DMS_X(STARTX+663) && Y > DMS_Y(STARTY+300) && Y < DMS_Y(STARTY+360) ||
					         X > DMS_X(STARTX+680) && X < DMS_X(STARTX+825) && Y > DMS_Y(STARTY+300) && Y < DMS_Y(STARTY+360) )
					{
...
//---------------------------------------------------------------------------------------------------------	
	void SetClickData(void)
	{
		...
		, MAKE_NUM, WORK_DOCU_RECEIVE_YMD, INST_FLAG, INST_LOC, Trim(BOILER_INST_FIRM_CD), BO1_RSLT \
		...
		{	
			idx = 0;
			sql->GetValue( sql, idx++, 'U', (long*) stBfBoil.CREATE_YMD			      , sizeof(stBfBoil.CREATE_YMD				), DECRYPT );
			sql->GetValue( sql, idx++, 'U', (long*) stBfBoil.MTR_NUM				  , sizeof(stBfBoil.MTR_NUM					), DECRYPT );
			sql->GetValue( sql, idx++, 'U', (long*) stBfBoil.BURNER_NUM			      , sizeof(stBfBoil.BURNER_NUM				), DECRYPT );	
			sql->GetValue( sql, idx++, 'U', (long*) stBfBoil.CHK_OBJ_BOILER_YN		  , sizeof(stBfBoil.CHK_OBJ_BOILER_YN		), DECRYPT );	
			sql->GetValue( sql, idx++, 'U', (long*) stBfBoil.NEW_REPL_FLAG			  , sizeof(stBfBoil.NEW_REPL_FLAG			), DECRYPT );
			sql->GetValue( sql, idx++, 'U', (long*) stBfBoil.BURNER_MODEL_CD		  , sizeof(stBfBoil.BURNER_MODEL_CD			), DECRYPT );
			sql->GetValue( sql, idx++, 'U', (long*) stBfBoil.BURNER_CLASS_CD		  , sizeof(stBfBoil.BURNER_CLASS_CD			), DECRYPT );
			sql->GetValue( sql, idx++, 'U', (long*) stBfBoil.BURNER_KIND_NUM		  , sizeof(stBfBoil.BURNER_KIND_NUM			), DECRYPT );
			sql->GetValue( sql, idx++, 'U', (long*) stBfBoil.BURNER_CAPA			  , sizeof(stBfBoil.BURNER_CAPA				), DECRYPT );
			sql->GetValue( sql, idx++, 'U', (long*) stBfBoil.BURNER_CAPA_UNIT		  , sizeof(stBfBoil.BURNER_CAPA_UNIT		), DECRYPT );	
			sql->GetValue( sql, idx++, 'U', (long*) stBfBoil.BURNER_INST_YMD		  , sizeof(stBfBoil.BURNER_INST_YMD			), DECRYPT );	
			sql->GetValue( sql, idx++, 'U', (long*) stBfBoil.BURNER_REMOV_YMD		  , sizeof(stBfBoil.BURNER_REMOV_YMD		), DECRYPT );
			sql->GetValue( sql, idx++, 'U', (long*) stBfBoil.BURNER_MODEL_NM		  , sizeof(stBfBoil.BURNER_MODEL_NM			), DECRYPT );
			sql->GetValue( sql, idx++, 'U', (long*) stBfBoil.MAKER_FLAG			      , sizeof(stBfBoil.MAKER_FLAG				), DECRYPT );
			sql->GetValue( sql, idx++, 'U', (long*) stBfBoil.MAKER_NUM				  , sizeof(stBfBoil.MAKER_NUM				), DECRYPT );
			sql->GetValue( sql, idx++, 'U', (long*) stBfBoil.MAKER_NM				  , sizeof(stBfBoil.MAKER_NM				), DECRYPT );
			sql->GetValue( sql, idx++, 'U', (long*) stBfBoil.BOILER_FORM			  , sizeof(stBfBoil.BOILER_FORM				), DECRYPT );	
			sql->GetValue( sql, idx++, 'U', (long*) stBfBoil.MAKE_NUM				  , sizeof(stBfBoil.MAKE_NUM				), DECRYPT );	
			sql->GetValue( sql, idx++, 'U', (long*) stBfBoil.WORK_DOCU_RECEIVE_YMD	  , sizeof(stBfBoil.WORK_DOCU_RECEIVE_YMD	), DECRYPT );
			sql->GetValue( sql, idx++, 'U', (long*) stBfBoil.INST_FLAG				  , sizeof(stBfBoil.INST_FLAG				), DECRYPT );
			sql->GetValue( sql, idx++, 'U', (long*) stBfBoil.INST_LOC				  , sizeof(stBfBoil.INST_LOC				), DECRYPT );
			sql->GetValue( sql, idx++, 'U', (long*) stBfBoil.BOILER_INST_FIRM_CD	  , sizeof(stBfBoil.BOILER_INST_FIRM_CD		), DECRYPT );
			sql->GetValue( sql, idx++, 'U', (long*) stBfBoil.BO1_RSLT				  , sizeof(stBfBoil.BO1_RSLT				), DECRYPT );
			sql->GetValue( sql, idx++, 'U', (long*) stBfBoil.BO2_RSLT				  , sizeof(stBfBoil.BO2_RSLT				), DECRYPT );	
			sql->GetValue( sql, idx++, 'U', (long*) stBfBoil.BO3_RSLT				  , sizeof(stBfBoil.BO3_RSLT				), DECRYPT );	
			sql->GetValue( sql, idx++, 'U', (long*) stBfBoil.BO4_RSLT				  , sizeof(stBfBoil.BO4_RSLT				), DECRYPT );
			sql->GetValue( sql, idx++, 'U', (long*) stBfBoil.CHK_RSLT				  , sizeof(stBfBoil.CHK_RSLT				), DECRYPT );
			sql->GetValue( sql, idx++, 'U', (long*) stBfBoil.SEND_FLAG				  , sizeof(stBfBoil.SEND_FLAG				), DECRYPT );
			sql->GetValue( sql, idx++, 'U', (long*) stBfBoil.CRT_EMPID				  , sizeof(stBfBoil.CRT_EMPID				), DECRYPT );
			sql->GetValue( sql, idx++, 'U', (long*) stBfBoil.CRT_IP				      , sizeof(stBfBoil.CRT_IP					), DECRYPT );
			sql->GetValue( sql, idx++, 'U', (long*) stBfBoil.CHG_FLAG				  , sizeof(stBfBoil.CHG_FLAG				), DECRYPT );	
			sql->GetValue( sql, idx++, 'U', (long*) stBfBoil.BURNER_CAPA_UNIT_NM	  , sizeof(stBfBoil.BURNER_CAPA_UNIT_NM		), DECRYPT );	
			sql->GetValue( sql, idx++, 'U', (long*) stBfBoil.BURNER_CLASS_NM		  , sizeof(stBfBoil.BURNER_CLASS_NM			), DECRYPT );	
			sql->GetValue( sql, idx++, 'U', (long*) stBfBoil.BURNER_KIND_NM		      , sizeof(stBfBoil.BURNER_KIND_NM			), DECRYPT );
			sql->GetValue( sql, idx++, 'U', (long*) stBfBoil.BOILER_FORM_NM		      , sizeof(stBfBoil.BOILER_FORM_NM			), DECRYPT );
		}
	...
	void REDRAW(void)
	{
		...
		if( g_nAddrFlag == 0)
		{
			...
			if( Str_Cmp( stBf.SINGLE_COLIVE_FLAG, "10") == 0 )
			{
				...
				{
					//Str_Cpy(szAddr,  stBf.LOT_NUM_SECOND_ADDR);
					Str_Cat(szAddr,  " ");
			...
			else
			{
				...
				{
					//Str_Cpy(szAddr,  stBf.CO_LIVE_NM);
					Str_Cat(szAddr,  " ");
		...
		if( stBf.SEND_FLAG[0] == 'N' || stBf.SEND_FLAG[0] == '' )
		{
...
//---------------------------------------------------------------------------------------------------------
	void CHG_DRAW(void)
	{
		...
		if( stBfBoil.BOILER_INST_FIRM_CD[0] != '\0' && Str_Len(stBfBoil.BOILER_INST_FIRM_CD) > 0 )
		{
			//설치업체 , 
			Mem_Set( (byte*)szSql, 0x00, sizeof(szSql) );
			Mem_Set( (byte*)sztmp, 0x00, sizeof(sztmp) );
...
//------------------------------------------------------------------	
	bool Save_Result(void)
	{
		...
		if( Str_Cmp(stBf.CHK_RSLT, "21") == 0 )
		{
			...
			Save_Nogood();	//부적합 목록 SEND_YN = Y로 변경
		}
		...
		//2016-05-13 Sanghyun Lee
		//화면 display가 바뀌기 때문에, 굳이 메세지를 띄우지 않아도됨.
		//else
		//{
