...
//약속메모
	...
	DlgObject	DlgRes[] = 
	{
		...
		//DLG_TEXT( STARTX+467,     Line(11),  535, SYH, 0, 0, EDITSTY_BORDER, 0, RED, WHITE, TTL_SERVADD, "사전접수 고객님"),
		//20240725
		DLG_TEXT( STARTX+467,     Line(11),  535, SYH, 0, 0, EDITSTY_BORDER, 0, RED, WHITE, TTL_SERVADD, "정보연계 고객님"), //szInfo_Trans_yn  Y 인 경우
