...
*/
	...
	DlgObject	DlgRes[] = 
	{
		...
		//전체 옆부분에 콤보를 넣어달라고 함. 너무 좁은데? => 콤보박스로 교체해 달라는 걸로 이해 함.
	...
	void	OnInit(char bFirst)
	{
		...
		switch (bFirst)
		{
			case INIT_MAIN:
				...
				ListCtrl_AddItem (Get_hDlgCtrlByID(CMB_GMTYPE+2), "일반형", 0, ICON_NONE);
				ListCtrl_AddItem (Get_hDlgCtrlByID(CMB_GMTYPE+2), "특수형", 0, ICON_NONE);
