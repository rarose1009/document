...
//화면 상단 공통 메뉴 모음
	...
	DlgObject	DlgRes[] = 
	{
		...
		DLG_BUTTON(STARTX+600, STARTY+859, 400, 40, 0, 0, BUTSTY_BOLD, BUTSTY_BORDER, BTNMENUFRCOLOR, BTNCTRLBKCOLOR, CALL_FUNC , "", BID_SAVE, "저장"),
		...
		// DLG_TEXT(STARTX, 	 STARTY+360, 300, 50, 0, 0, 0, EDITSTY_BORDER, TXTTTLFRCOLOR, TXTCTRLBK, 	TXT_DATA30,"제조사검색"),
		// DLG_BUTTON(STARTX+300, STARTY+360, 700,  50, 175  ,  50, BUTSTY_BOLD, BUTSTY_BORDER, BTNMENUFRCOLOR, BTNCTRLMNBKCOLOR, CALL_FUNC , "", BID_WRITE3,  ""),
		// DLG_TEXT(  STARTX+300, STARTY+360, 700,  50, 175  ,  50, EDITSTY_BOLD, EDITSTY_BORDER, TXTFRCOLOR, EDTCTRLBK, EDT_DATA8,  ""),

		DLG_TEXT(STARTX, 	 STARTY+460, 300, 50, 0, 0, 0, EDITSTY_BORDER, TXTTTLFRCOLOR, TXTCTRLBK, 	TXT_DATA8, "설치위치"),
		DLG_TEXT(STARTX, 	 STARTY+510, 300, 50, 0, 0, 0, EDITSTY_BORDER, TXTTTLFRCOLOR, TXTCTRLBK, 	TXT_DATA9, "형식"),
		DLG_TEXT(STARTX, 	 STARTY+560, 300, 50, 0, 0, 0, EDITSTY_BORDER, TXTTTLFRCOLOR, TXTCTRLBK, 	TXT_DATA10, "제조번호"),
		DLG_TEXT(STARTX, 	 STARTY+610, 300, 50, 0, 0, 0, EDITSTY_BORDER, TXTTTLFRCOLOR, TXTCTRLBK, 	TXT_DATA11, "설치업체"),
		DLG_TEXT(STARTX, 	 STARTY+660, 300, 50, 0, 0, 0, EDITSTY_BORDER, TXTTTLFRCOLOR, TXTCTRLBK, 	TXT_DATA12, "대표자명"),
		DLG_TEXT(STARTX+300, STARTY+660, 700, 50, 0, 0, 0, EDITSTY_BORDER, TXTFRCOLOR, TXTINCTRLBK, TXT_DATA19, ""),
		DLG_TEXT(STARTX,	 STARTY+710, 300, 50, 0, 0, 0, EDITSTY_BORDER, TXTTTLFRCOLOR, TXTCTRLBK, 	TXT_DATA13, "면허번호"),
		DLG_TEXT(STARTX+300, STARTY+710, 700, 50, 0, 0, 0, EDITSTY_BORDER, TXTFRCOLOR, TXTINCTRLBK, TXT_DATA20, ""),
		DLG_TEXT(STARTX, 	 STARTY+760, 250, 50, 0, 0, 0, EDITSTY_BORDER, TXTTTLFRCOLOR, TXTCTRLBK, 	TXT_DATA14, "전화번호"),
		DLG_TEXT(STARTX+250, STARTY+760, 205, 50, 0, 0, 0, EDITSTY_BORDER, TXTFRCOLOR, TXTINCTRLBK, TXT_DATA21, ""),
		DLG_TEXT(STARTX+455, STARTY+760, 50 , 50, 0, 0, 0, EDITSTY_BORDER, TXTFRCOLOR, TXTINCTRLBK, 	TXT_DATA15, "-"),
		DLG_TEXT(STARTX+505, STARTY+760, 210, 50, 0, 0, 0, EDITSTY_BORDER, TXTFRCOLOR, TXTINCTRLBK, TXT_DATA22, ""),
		DLG_TEXT(STARTX+715, STARTY+760, 50 , 50, 0, 0, 0, EDITSTY_BORDER, TXTFRCOLOR, TXTINCTRLBK, 	TXT_DATA16, "-"),
		DLG_TEXT(STARTX+765, STARTY+760, 235, 50, 0, 0, 0, EDITSTY_BORDER, TXTFRCOLOR, TXTINCTRLBK, TXT_DATA23, ""),
		DLG_TEXT(STARTX, 	 STARTY+810, 300, 50, 0, 0, 0, EDITSTY_BORDER, TXTTTLFRCOLOR, TXTCTRLBK, 	TXT_DATA17, "설치구분"),
		DLG_TEXT(STARTX+300, STARTY+810, 700, 50, 0, 0, 0, EDITSTY_BORDER, TXTFRCOLOR, TXTINCTRLBK, TXT_DATA25, "신규"),

		DLG_TEXT(STARTX, 	  STARTY+410, 300, 50, 0, 0, 0, EDITSTY_BORDER, TXTTTLFRCOLOR, TXTCTRLBK, TXT_DATA7, "설치일자"),
		...
		DLG_EDIT( STARTX+300,  STARTY+410, 200, 50, 0, 0, EDITSTY_BOLD, 0, TXTFRCOLOR, EDTCTRLBK, EDT_DATA5, 4,  ""),
		DLG_TEXT(STARTX+500,  STARTY+410, 18, 20, 0, 0, 0, 0, TXTFRCOLOR, EDTCTRLBK, TXT_DATA26, ""),
		DLG_TEXT(STARTX+500,  STARTY+430, 18, 30, 0, 0, 0, 0, TXTFRCOLOR, EDTCTRLBK, TXT_DATA27, "."),
		DLG_EDIT( STARTX+518,  STARTY+410, 145, 50, 0, 0, EDITSTY_BOLD, 0, TXTFRCOLOR, EDTCTRLBK, EDT_DATA6, 2,  ""),
		DLG_TEXT(STARTX+663,  STARTY+410, 17, 20, 0, 0, 0, 0, TXTFRCOLOR, EDTCTRLBK, TXT_DATA28, ""),
		DLG_TEXT(STARTX+663,  STARTY+430, 17, 30, 0, 0, 0, 0, TXTFRCOLOR, EDTCTRLBK, TXT_DATA29, "."),
		DLG_EDIT( STARTX+680,  STARTY+410, 145, 50, 0, 0, EDITSTY_BOLD, 0, TXTFRCOLOR, EDTCTRLBK, EDT_DATA7, 2,  ""),
		DLG_BUTTON(STARTX+825, STARTY+410, 175, 50, 0, 0, BUTSTY_BOLD, BUTSTY_BORDER, TXTFRCOLOR, PDAEDTCTRLBK, CALL_FUNC , "", BID_INST_YMD, "▼"),
...
Finally:
	...
	// 20240311 제조사검색기능 추가했으나, 사용안한다하여 주석 처리
	// void SetComboMaker(void)
	// {	
	// 	char szSql[300];
	// 	char sztmp[100];
	...
	void	OnPointing(long nAction, long X, long Y)
	{
		...
		if( POINTING_UP == nAction )
		{
			if( theDevInfo.m_nType > FAMILY_PDA )
			{
				...
				// else if (X > DMS_X(STARTX+800) && X < DMS_X(STARTX+1000) && Y > DMS_Y(STARTY+300) && Y < DMS_Y(STARTY+350))
				// {
