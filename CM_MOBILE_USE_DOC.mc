...
//	#define USE_ON_TIMER
	...
	void OnSelect(long Index)
	{
		...
		if( m_bFirst == INIT_CUSTINFO )
		{
			...
			{
				//[TODO] 요금청구방법 체크
				char* s = EditCtrl_GetStr(Get_hDlgCtrlByID(CMB_CI_BILL_SEND_METHOD));
				BOOL b = MATCH(s, "문자(LMS)") || MATCH(s, "LMS+송달") || MATCH(s, "이메일+LMS") || MATCH(s, "모바일+LMS");
	...
	void SetCombo(void)
	{
		...
		if( m_bFirst == INIT_CUSTINFO )
		{
			...
			{
				ListCtrl_AddItem (Get_hDlgCtrlByID(CMB_CI_EMAIL+2), MC_EMAIL_ADDR[i].Str, i, ICON_NONE);
			}
			...
			{
				ListCtrl_AddItem (Get_hDlgCtrlByID(CMB_CI_BILL_SEND_METHOD+2), MUD_BILL_SEND_METHOD[i].Str, i, ICON_NONE);
			}
			//테스트를 위한 추가
			...
			{
				ListCtrl_AddItem (Get_hDlgCtrlByID(CMB_CI_BILL_SEND_METHOD+2), MUD_BILL_SEND_METHOD_DOUBLE[0].Str, i++, ICON_NONE);
			}
			else if(Str_Cmp( stMudData.BILING_METHOD, "17" ) == 0)
			{
				ListCtrl_AddItem (Get_hDlgCtrlByID(CMB_CI_BILL_SEND_METHOD+2), MUD_BILL_SEND_METHOD_DOUBLE[1].Str, i++, ICON_NONE);
			}
			else if(Str_Cmp( stMudData.BILING_METHOD, "18" ) == 0)
			{
				ListCtrl_AddItem (Get_hDlgCtrlByID(CMB_CI_BILL_SEND_METHOD+2), MUD_BILL_SEND_METHOD_DOUBLE[2].Str, i++, ICON_NONE);
			}
			else if(Str_Cmp( stMudData.BILING_METHOD, "47" ) == 0)
			{
				ListCtrl_AddItem (Get_hDlgCtrlByID(CMB_CI_BILL_SEND_METHOD+2), MUD_BILL_SEND_METHOD_DOUBLE[3].Str, i++, ICON_NONE);
			}
			else if(Str_Cmp( stMudData.BILING_METHOD, "48" ) == 0)
			{
				ListCtrl_AddItem (Get_hDlgCtrlByID(CMB_CI_BILL_SEND_METHOD+2), MUD_BILL_SEND_METHOD_DOUBLE[4].Str, i++, ICON_NONE);
			}
			else if(Str_Cmp( stMudData.BILING_METHOD, "78" ) == 0)
			{
				ListCtrl_AddItem (Get_hDlgCtrlByID(CMB_CI_BILL_SEND_METHOD+2), MUD_BILL_SEND_METHOD_DOUBLE[5].Str, i++, ICON_NONE);
			}
		}
		/********************************/
		/* 자동이체                     */
		...
		else if( m_bFirst == INIT_AUTOTRANS )
		{
			...
			{
				ListCtrl_AddItem (Get_hDlgCtrlByID(CMB_AT_PAY_METHOD+2), MUD_PAY_METHOD[i].Str, i, ICON_NONE);
			}
			...
			{
				ListCtrl_AddItem (Get_hDlgCtrlByID(CMB_AT_DEP_TEL_DDD+2), SCTEL_DDD[i].Str, i+1, ICON_NONE);
			}
			...
			for ( i = 0 ;  SCTEL_DDD[i].Str[0] != 0 ; i++)
			{
				ListCtrl_AddItem (Get_hDlgCtrlByID(CMB_AT_ALT_TEL_DDD+2), SCTEL_DDD[i].Str, i+1, ICON_NONE);
			}
		}
	}
	...
	void SetCombo_Filter(void)
	{
		...
		if( m_bFirst == INIT_AUTOTRANS )
		{
			//[TODO] 탭에서 선택된 화면들에 대한 콤보 옵션 처리
			char* s = EditCtrl_GetStr(Get_hDlgCtrlByID(CMB_AT_PAY_METHOD));
			if( MATCH(s, "지로") )
			{
	...
	void SetOzView_JsonBody( SQLITE sql )
	{
		...
		//[TODO] 청구방법 전문 결과 코드에 따라 화면의 콤보를 자동 설정해야 한다.
		/************** BILL_SEND_METHOD *****************************/
