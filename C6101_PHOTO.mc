...
//	#define USE_ON_SELECT
	...
	DlgObject	DlgRes[] = 
	{
		...
		DLG_BUTTON(STARTX,		STARTY+115, 500, 70, 0, 0, BUTSTY_BOLD, BUTSTY_BORDER, BTNMENUFRCOLOR, BTNCTRLBKCOLOR, CALL_FUNC , "", BID_PREVVIEW, "사진 보기"),
		DLG_BUTTON(STARTX+500,	STARTY+115, 500, 70, 0, 0, BUTSTY_BOLD, BUTSTY_BORDER, BTNMENUFRCOLOR, BTNCTRLBKCOLOR, CALL_FUNC , "", BID_PREVPHOTO, "사진 촬영"),
		DLG_BUTTON(STARTX,		STARTY+360, 500, 70, 0, 0, BUTSTY_BOLD, BUTSTY_BORDER, BTNMENUFRCOLOR, BTNCTRLBKCOLOR, CALL_FUNC , "", BID_AFTERVIEW, "사진 보기"),
		DLG_BUTTON(STARTX+500,	STARTY+360, 500, 70, 0, 0, BUTSTY_BOLD, BUTSTY_BORDER, BTNMENUFRCOLOR, BTNCTRLBKCOLOR, CALL_FUNC , "", BID_AFTERPHOTO, "사진 촬영"),
		DLG_BUTTON(STARTX+500,	STARTY+450, 500, 70, 0, 0, BUTSTY_BOLD, BUTSTY_BORDER, BTNMENUFRCOLOR, BTNCTRLBKCOLOR, CALL_FUNC , "", BID_OK, "확인"),
		
		DLG_TEXT(STARTX,			STARTY-29,  1000, 73, 0, 0, 0, EDITSTY_BORDER, TXTFRCOLOR, TXTCTRLBK, TXT_DATA1 , m_szPrevTitle),
		DLG_TEXT(STARTX,			STARTY+45,  500, 70, 0, 0, 0, EDITSTY_BORDER, TXTFRCOLOR, TXTCTRLBK, TXT_DATA2 , "사진 유무"),
		...
		DLG_TEXT(STARTX,			STARTY+290,  500, 70, 0, 0, 0, EDITSTY_BORDER, TXTFRCOLOR, TXTCTRLBK, TXT_DATA5 , "사진 유무"),
...
//				솔루션즈(현업) 요청으로 체크로직 제거. 교체 화면에서 '완료'버튼 누를시에만 체크 하도록.
